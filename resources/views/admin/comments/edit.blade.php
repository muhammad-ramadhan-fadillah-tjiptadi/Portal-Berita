...
@section('content')
    ...
    <div class="container py-4">
        <div class="card shadow-sm form-container">
            ...
            <div class="card-body">
                <form action="{{ route('admin.comments.update', $comment) }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="5"
                            required placeholder="Masukkan isi komentar">{{ old('content', $comment->content) }}</textarea>
                        @error('content')
                            <span class="error-message">
                                <i class="fas fa-exclamation-triangle me-1"></i>
                                {{ $message }}
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i> Update Komentar
                        </button>
                    </div>
                </form>
            </div>
