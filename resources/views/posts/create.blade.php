...
@if(!request()->has('category_id'))
                        <form action="{{ route('user.posts.create') }}" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required onchange="this.form.submit()">
                        ...
                        @else
                        <form action="{{ route('user.posts.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
